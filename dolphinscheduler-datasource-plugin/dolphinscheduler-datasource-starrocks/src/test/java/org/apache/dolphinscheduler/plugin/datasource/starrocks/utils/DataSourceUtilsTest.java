...
package org.apache.dolphinscheduler.plugin.datasource.starrocks.utils;
...
import org.apache.dolphinscheduler.plugin.datasource.starrocks.param.StarRocksDataSourceProcessor;
...
@PrepareForTest({Class.class, DriverManager.class, StarRocksDataSourceProcessor.class, DataSourceClientProvider.class,
...
public class DataSourceUtilsTest {
    ...
    public void testCheckDatasourceParam() {
        ...
        starrocksDatasourceParamDTO.setOther(other);
        DataSourceUtils.checkDatasourceParam(starrocksDatasourceParamDTO);
    ...
    public void testBuildConnectionParams() {
        ...
        ConnectionParam connectionParam = DataSourceUtils.buildConnectionParams(starrocksDatasourceParamDTO);
    ...
    public void testBuildConnectionParams2() {
        ...
        starrocksDatasourceParamDTO.setPort(3306);
        starrocksDatasourceParamDTO.setPassword("123456");
        ConnectionParam connectionParam = DataSourceUtils.buildConnectionParams(DbType.STARROCKS,
                JSONUtils.toJsonString(starrocksDatasourceParamDTO));
        Assert.assertNotNull(connectionParam);
    }
    ...
    public void testGetConnection() throws ExecutionException {
        ...
        connection = DataSourceClientProvider.getInstance().getConnection(DbType.STARROCKS, connectionParam);
    ...
    public void testGetJdbcUrl() {
        ...
        starrocksConnectionParam.setJdbcUrl("jdbc:mysql://localhost:3308");
        String jdbcUrl = DataSourceUtils.getJdbcUrl(DbType.STARROCKS, starrocksConnectionParam);
        Assert.assertEquals(
    ...
    public void testBuildDatasourceParamDTO() {
        ...
        Assert.assertNotNull(
                DataSourceUtils.buildDatasourceParamDTO(DbType.STARROCKS, JSONUtils.toJsonString(connectionParam)));

    }

    @Test
    public void testGetDatasourceProcessor() {
        Assert.assertNotNull(DataSourceUtils.getDatasourceProcessor(DbType.STARROCKS));
    }
